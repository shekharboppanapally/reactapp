        ...
        <div className='w-full py-[10rem] px-4 bg-white'>
            <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8'>
                <div className='w-full shadow-2xl flex flex-col p-4 my-8 rounded-lg hover:scale-105 duration-300'>
                    <img className='w-20 mx-auto mt-[-3rem] bg white' src={Signle} alt="/" />
                ...
                <div className='w-full shadow-2x flex flex-col p-4 md:my-0 my-8x rounded-lg hover:scale-105 duration-300'>
